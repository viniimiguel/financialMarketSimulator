    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/wallet/create").hasAnyRole("USER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/orders/buy").hasAnyRole("USER")
                        .requestMatchers(HttpMethod.POST, "/api/orders/sell").hasAnyRole("USER")
